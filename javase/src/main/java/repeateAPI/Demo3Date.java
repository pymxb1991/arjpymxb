...
/**
 * This is Description
 *  Data 中常用的  两个构造方法，一个成员方法getTime
 *
...
public class Demo3Date {
    public static void main(String[] args) {
        ...
        System.out.println(date);//Fri Apr 10 07:10:27 CST 2020  : data 中重写了toString 方法

        Date data1 = new Date(0L);
        System.out.println(data1);

        System.out.println(date.getTime()); //等同于 System.currentTimeMillis()
